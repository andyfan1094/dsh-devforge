...
import { IconStandards, IconBrowser, IconChart, IconServer, IconProject, IconRepo, IconFeishu, IconTiangong, IconUpdate, IconWorkflow } from './icons.tsx'
...
/** 页签类型。 */
type Tab = 'standards' | 'browser' | 'codeplan' | 'rag' | 'memory' | 'workflow' | 'remote' | 'projects' | 'repos' | 'feishu' | 'pluginupdate'
